<x-app-layout title="Ubah Nama Lengkap" :navbar-top="false" :navbar-bottom="false">
    ...
    <main id="main" class="mt-5 pt-3">
        ...
        <div class="px-4 px-md-5 ">
            <div class="input-group">
                <label class="d-block w-100 text-center mb-3 fw-bold" for="inputChangePIN">Masukan Nama Lengkap
                </label>
                <span class="input-group-text rounded-start" id="inputGroup-sizing-default">Nama</span>
                <input type="text" class="form-control" name="fullname" aria-label="Sizing example input"
                    aria-describedby="inputGroup-sizing-default" placeholder="Nama lengkap kamu">
            </div>
            <div id="inputErrorFullnameWrapper"></div>
    ...
    <x-slot name="scripts">
        ...
        <script src="{{ asset('js/Accounts/ChangeFullname.js') }}"></script>
    </x-slot>
</x-app-layout>
